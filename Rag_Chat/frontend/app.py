...
def determine_provider_combo(selection: Dict[str, Any]) -> str:
    ...
    embedding = selection.get("embedding_provider")
    if reasoning == "gemini" and generation == "gemini" and embedding == "gemini":
        return "gemini_only"
    if reasoning == "qwen" and generation == "gemini" and embedding == "gemini":
        return "qwen_reasoning_gemini_generation"
    if reasoning == "qwen" and generation == "qwen" and embedding == "qwen":
        return "qwen_only"
    if reasoning == "openrouter" and generation == "openrouter" and embedding == "openrouter":
        return "openrouter_only"
    if reasoning == "ollama" and generation == "ollama" and embedding == "ollama":
        return "ollama_only"
    if reasoning == "huggingface" and generation == "huggingface" and embedding == "huggingface":
