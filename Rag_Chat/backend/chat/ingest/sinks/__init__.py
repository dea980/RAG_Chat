...
- chroma.py        : 벡터 스토어 (semantic / 근사 검색, legacy)
- pgvector.py      : PostgreSQL VectorChunk (semantic + SQL-level ACL)
...
__all__ = ["ChromaSink", "CompositeSink", "KnowledgeOrmSink", "PgvectorSink"]
